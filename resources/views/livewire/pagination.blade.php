@if ($paginator->hasPages())
    <nav>
        <ul class="pagination">
            ...
            @else
                <li class="page-item">
                    <button type="button" wire:click="previousPage" class="page-link" rel="prev">&lsaquo;</button>
                </li>
            @endif
            ...
            @if ($paginator->hasMorePages())
                <li class="page-item">
                    <button type="button" wire:click="nextPage" class="page-link" rel="next">&rsaquo;</button>
                </li>
            @else
